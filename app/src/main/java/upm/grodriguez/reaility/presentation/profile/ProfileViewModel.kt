...
import upm.grodriguez.reaility.domain.repository.ReloadUserResponse
import upm.grodriguez.reaility.domain.repository.RevokeAccessResponse
...
class ProfileViewModel @Inject constructor(
    ...
    fun username() = repo.currentUser?.displayName ?: "No username"

    fun email() = repo.currentUser?.email ?: "No email"

    fun photoUrl() = repo.currentUser?.photoUrl ?: "No photo url"

    fun userId() = repo.currentUser?.uid ?: "No user id"
}